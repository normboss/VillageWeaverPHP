        ...
        <div class="contact-block">
          ...
          <div class="form-container">
            ...
            <section class="contentBox3">
              <h3>Contact Form</h3>
<!--              <form action="send_form_email.php" class="contactform" method="post" name="contactform">
              ...
              <form method= "post" class="contactform" action="https://www1.domain.com/scripts/formemail.bml" name="contactform">
                ...
                <input type="hidden" name="subject" value="form submission from %%first_name%%">
                  ...
                  -->
                <input type="hidden" name="required" value="first_name,last_name,email,telephone,comments"> 
