...
<html>
  ...
  <body>
    ...
    <div class="statement-parent">
      <div class="statement">
        <!--      <uL>
                <li><span>Contact me for custom orders.</span></li>
                <li><span>Let's discuss what you can have created just for you!</span></li>
                <li><span>I am always happy to answer questions about my work.</span></li>
              </ul>-->
    ...
    <div class="contact-container">
      ...
      <div class="contact-block">
        <div class="contact-image big-image">
          <img src="./images/contact_phyllis.jpg" alt="picture" >
        </div>
        <div class="contact-image small-image">
        ...
        <div class="form-container">
          ...
          <section class="contentBox2a">
            <h3>Contact Form</h3>
<!--            <form action="https://www.mainevillageweaver.com/send_form_email.php" class="contactform" method="post" name="contactform">
              <form method= "post"class="contactform" action="https://www1.domain.com/scripts/formemail.bml" name="contactform">
              <label for="first_name">First Name *</label> 
              <input maxlength="50" name="first_name" size="20" type="text"> 
