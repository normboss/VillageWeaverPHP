    ...
    <div class="shawls-container-mobile">
        ...
        <div class="shawls-block">
            <div class="copy-and-image">
                <div class="image-block">
                    <!--<img src="./images/shawl_knot1.jpg" alt="picture" >-->
                <?php outputCode("shawl_knotweed1", "jpg", "shawl_knotweed2a", "jpg", "M" ); ?>
                </div>
                <div class="copy-block">
                    ...
                    <div class="small-heading-row">
                        Knotweed Shawl<span class="dev"><?php echo $mobileBlockNum++; ?></span>
                    </div>
                    <div class="spacer10"></div>
                    <div class="content-text-block">
        ...
        <div class="shawls-block">
            <div class="copy-and-image">
                <div class="image-block">
                    <img src="./images/shawl_steel.jpg">
<!--                    <img id="img-top-1" src="./images/shawl_steel_1b.jpg" alt="Image1">
                    <img id="img-top-0" src="./images/shawl_steel_2b.jpg" class="img-top" alt="Image1">
                    <span class="click-for-closeup">Click image for alternate view</span>-->
                </div>
                <!--        <div class="image-block steel-grey-shawl-images">
                ...
                <div class="copy-block">
                    <div class="spacer20"></div>
                    <div class="small-heading-row">
                        Steel Grey Shawl<span class="dev"><?php echo $mobileBlockNum++; ?></span>
                    </div>
                    <div class="spacer10"></div>
                    <div class="content-text-block">
                        <div>Merino wool/tencel blend hand woven</div>
        ...
        <div class="shawls-block">
            <div class="copy-and-image">
                <div class="image-block">
                    <!--<img src="./images/.jpg" alt="Image1">-->
                    <?php outputCode("shawl_white_2a", "jpg", "shawl_white_1a", "jpg", "M" ); ?>
                </div>
                ...
                <div class="copy-block">
                    ...
                    <div class="small-heading-row">
                        Naturally White Shawl
<span class="dev"><?php echo $mobileBlockNum++; ?></span>
                    </div>
                    <div class="spacer10"></div>
                    <div class="content-text-block">
                        <div>ut sem viverra aliquet eget sit amet tellus</div>
                        <div>ipsum faucibus vitae aliquet</div>
                        <br>
                        Dry clean only
                        <div class="description-and-price">
                            <span>Measures 24 x 94 inches</span>
                            <!--<span id="?????????M" class="price ?????????????">???</span>-->
                        </div>
                        <br>
                        <div class="add-to-cart">
							<button>Create New Button</button>
        ...
        <div class="shawls-block">
            <div class="copy-and-image">
                ...
                <div class="copy-block">
                    ...
                    <div class="small-heading-row">
                        <span>Sea Foam Shawl</span><span class="dev"><?php echo $mobileBlockNum++; ?></span>
                    </div>
                    <div class="spacer10"></div>
                    <div class="content-text-block">
                        <div>
        ...
        <div class="shawls-block">
            <div class="copy-and-image">
                <div class="image-block">
                <?php outputCode("shawl_rust_1", "jpg", "shawl_rust2a", "jpg", "M" ); ?>
                </div>

                <div class="copy-block">
                    <div class="spacer20"></div>
                    <div class="small-heading-row">
                        Auburn Rusty Red Shawl<span class="dev"><?php echo $mobileBlockNum++; ?></span>
                    </div>
                    <div class="spacer10"></div>
                    <div class="content-text-block">
                        <div>ut sem viverra aliquet eget sit amet tellus</div>
        ...
        <div class="shawls-block">
            <div class="copy-and-image">
                <div class="image-block">
                <?php outputCode("wrap_asm_jewel1", "jpg", "wrap_asm_teal_2a", "jpg", "M" ); ?>
                </div>
                <div id="asymmetrical" class="copy-block">
                    <br>
                    <div class="small-heading-row">
                        Asymmetrical Wrap in Jewel<span class="dev"><?php echo $mobileBlockNum++; ?></span>
                    </div>
                    <div class="spacer20"></div>
                    <div class="content-text-block">
        ...
        <div class="shawls-block">
            <div class="copy-and-image">
                <div class="image-block">
                <?php outputCode("shawl_steel_1b", "jpg", "shawl_steel_2b", "jpg", "M" ); ?>
                </div>

                <div class="copy-block">
                    <div class="spacer20"></div>
                    <div class="small-heading-row">
                        Asymetrical Wrap in Steel Grey<span class="dev"><?php echo $mobileBlockNum++; ?></span>
                    </div>
                    <div class="spacer10"></div>
                    <div class="content-text-block">
                        <div>ut sem viverra aliquet eget sit amet tellus</div>
        ...
        <div class="shawls-block">
            <div class="copy-and-image">
                <div class="image-block">
                <?php outputCode("black_merino", "jpg", "black_merino2", "jpg", "M" ); ?>
                </div>
                ...
                <div class="copy-block">
                    ...
                    <div class="small-heading-row">
                      Classic Black
Merino Tencel  Wrap<span class="dev"><?php echo $mobileBlockNum++; ?></span>
                    </div>
                    <div class="spacer10"></div>
                    <div class="content-text-block">
                        <div>ut sem viverra aliquet eget sit amet tellus</div>
        ...
        <div class="shawls-block">
            <div class="copy-and-image">
                <div class="image-block">
                <?php outputCode("wrap_black_cotton1", "jpg", "wrap_black2", "jpg", "M" ); ?>
                </div>

                <div class="copy-block">
                    <div class="spacer20"></div>
                    <div class="small-heading-row">
                        in pellentesque massa placerat<span class="dev"><?php echo $mobileBlockNum++; ?></span>
                    </div>
                    <div class="spacer10"></div>
                    <div class="content-text-block">
                        <div>ut sem viverra aliquet eget sit amet tellus</div>
        ...
        <div class="shawls-block">
            <div class="copy-and-image">
                ...
                <div id="asymmetrical" class="copy-block">
                    ...
                    <div class="small-heading-row">
                        Asymetrical Knotweed Wrap<span class="dev"><?php echo $mobileBlockNum++; ?></span>
                    </div>
                    <div class="spacer20"></div>
                    <div class="content-text-block">
                        <div>
        ...
        <div class="shawls-block">
            <div class="copy-and-image">
                <div class="image-block">
                <?php outputCode("scarf_lobster_red", "jpg", "scarf_red_1b", "jpg", "M" ); ?>
                </div>

                <div class="copy-block">
                    <div class="spacer20"></div>
                    <div class="small-heading-row">
                        Lobster Red Scarf<span class="dev"><?php echo $mobileBlockNum++; ?></span>
                    </div>
                    <div class="spacer10"></div>
                    <div class="content-text-block">
                        <div>ut sem viverra aliquet eget sit amet tellus</div>
        ...
        <div class="shawls-block">
            <div class="copy-and-image">
                ...
                <div id="asymmetrical" class="copy-block">
                    <div class="spacer20"></div>
                    <div class="small-heading-row">
                        Open Weave Knotweed Scarf<span class="dev"><?php echo $mobileBlockNum++; ?></span>
                    </div>
                    <div class="spacer10"></div>
                    <div class="content-text-block">
        ...
        <div class="shawls-block">
            <div class="copy-and-image">
                ...
                <div id="asymmetrical" class="copy-block">
                    <div class="spacer20"></div>
                    <div class="small-heading-row">
                        Sea Glass Scarf<span class="dev"><?php echo $mobileBlockNum++; ?></span>
                    </div>
                    <div class="spacer10"></div>
                    <div class="content-text-block">
                        <div>The greens and blues of beach</div>
